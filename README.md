...
![SEO Gravity MCP Banner](https://img.shields.io/badge/MCP-Protocol-blue?style=for-the-badge&logo=anthropic)
...
**The Ultimate Next-Gen SEO, GEO (Generative Engine Optimization) & Competitor Intelligence Suite for AI Coding Agents.**

[Features](#-key-features) • [Quickstart](#-quickstart) • [Tool Catalog](#-complete-tool-catalog-28-tools) • [Antigravity Integration](#-antigravity-integration) • [License](#-license)
...
**SEO Gravity MCP** is a comprehensive [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server and AI skill suite designed for Antigravity, Claude Desktop, Cursor, and any MCP-compatible client.

Unlike legacy SEO tools, SEO Gravity is built for the **2025–2026 search landscape**:
- 🤖 **GEO / AEO**: Optimizes content for **Google AI Overviews**, **Perplexity.ai**, and **ChatGPT Search**.
- 🧠 **Information Gain**: Evaluates content novelty vs top-10 SERP competitors to eliminate generic AI fluff.
- ⚡ **Zero Paid API Requirement**: Uses intelligent web scraping, Google Autocomplete, JSDOM, TF-IDF NLP, and IndexNow with **$0 mandatory monthly API costs**.
- 💻 **Dual Mode (Local & Live)**: Audits local dev servers (`localhost:3000`), raw HTML strings, and Markdown drafts just as easily as live production URLs.
...
Configure `seo-gravity` in `.agents/mcp_config.json`:
...
```json
{
  "mcpServers": {
    "seo-gravity": {
      "command": "node",
      "args": ["d:/aide/seo-gravity-mcp/seo-gravity-mcp/dist/index.js"],
      "env": {
...
The bundled skill `.agents/skills/seo-mastery/SKILL.md` is automatically loaded by Antigravity to enable autonomous SEO workflows.
